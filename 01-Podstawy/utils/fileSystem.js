//Platforma Node.js to środowisko uruchomieniowe JS po stronie serwera.

//Dziedziny zastosowania technoligii:
//Programowanie API
...
//Jakikolwiek biznes wykorzystujący Node.js może zatrudnić mniej programistów
//wykorzystać mniej serwerów, zmniejszyc czas pisania aplikacji

//Zaczynamy od inicjowania Node.js
//Aby to zrobić uzywamy komenty "npm init" i po kolej wypełniamy pola
...
//importujemy naszą zmienną srodowiskową
...
const readFile = async (filename) => {
    ...
    if (config.readingEnabled) {
      ...
      // w tym momencie po uruchomieniu pliku dostaniemy dane z Buffer w formie liczb i cyfr. Nic co mozemy zrozumiec. 
      // Aby zrozumiec musimy sparsowac te dane i wywolac na data metode toString(). 
      // Ta metoda przeczyta nam tekst ale aby otworzyc innego typu pliki musimy uzyc innych metod do nich stworzonych.
